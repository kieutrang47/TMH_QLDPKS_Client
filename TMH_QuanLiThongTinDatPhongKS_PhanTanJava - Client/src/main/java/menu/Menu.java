...
//        {"~WEB APP~"},
        {"Phòng"},
        {"Quản lí","Khách hàng", "Phòng","Nhân viên"},
        {"Thống kê", "Hoá đơn theo năm", "Hoá đơn theo ngày", "Doanh thu"},
        {"Hoá đơn"},
        
      
        {"Cài đặt","Tài khoản","Đổi mật khẩu", "Hỗ trợ","Đăng xuất"}
    };
    ...
    private final String headerName = "The Moon Hotel 2";
    ...
    private void init() {
     ...
     // Tải tài nguyên hình ảnh
        URL logoUrl = getClass().getResource("/icon/png/logo.png");
         if (logoUrl != null) {
              ImageIcon originalIcon = new ImageIcon(logoUrl);
               // Thay đổi kích thước hình ảnh về 34x34 pixel
                Image scaledImage = originalIcon.getImage().getScaledInstance(64, 64, Image.SCALE_SMOOTH);
               header.setIcon(new ImageIcon(scaledImage));
           } else {
               System.err.println("Tài nguyên logo không tìm thấy: /icon/png/logo.png");
            }
